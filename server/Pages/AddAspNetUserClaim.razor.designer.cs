...
{
    public partial class AddAspNetUserClaimComponent : ComponentBase
    {
        ...
        protected async System.Threading.Tasks.Task Load()
        {
            ...
            aspnetuserclaim = new IyaElepoApp.Models.ConData.AspNetUserClaim(){};
        }
        ...
        protected async System.Threading.Tasks.Task Form0Submit(IyaElepoApp.Models.ConData.AspNetUserClaim args)
        {
            try
            {
                var conDataCreateAspNetUserClaimResult = await ConData.CreateAspNetUserClaim(aspnetuserclaim);
                DialogService.Close(aspnetuserclaim);
            }
            catch (System.Exception conDataCreateAspNetUserClaimException)
            {
                NotificationService.Notify(new NotificationMessage(){ Severity = NotificationSeverity.Error,Summary = $"Error",Detail = $"Unable to create new AspNetUserClaim!" });
            }
        }
