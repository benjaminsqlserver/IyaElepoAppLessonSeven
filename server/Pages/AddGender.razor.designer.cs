...
namespace IyaElepoApp.Pages
{
    public partial class AddGenderComponent : ComponentBase
    {
        ...
        IyaElepoApp.Models.ConData.Gender _gender;
        protected IyaElepoApp.Models.ConData.Gender gender
        {
            get
            {
                return _gender;
        ...
        {
            gender = new IyaElepoApp.Models.ConData.Gender(){};
        }

        protected async System.Threading.Tasks.Task Form0Submit(IyaElepoApp.Models.ConData.Gender args)
        {
            try
            {
